...
public class Humanannotations {
	 ...
	 */  
        ...
        public Humanannotations( String annotationsFilename, String name) {

                this.filename = annotationsFilename;
                this.phasename = name;
	 ...
	 * arrylist
	 * @param annotationFilename is the name of the textfile storing 
